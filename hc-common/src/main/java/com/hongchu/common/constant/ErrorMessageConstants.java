...
public final class ErrorMessageConstants {
    ...
    public static final String ERROR_USERNAME_FORMAT = "用户名格式错误，请输入{}-{}位长度的字母或数字";
    public static final String ERROR_PASSWORD_FORMAT = "密码格式错误，必须包含字母和数字，可选10种特殊字符(@#$%^&+=-_)，长度{}-{}位";
